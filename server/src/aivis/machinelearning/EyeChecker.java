...
public class EyeChecker {
    ...
    public EyeChecker(){
        ...
        //excuteCommand = new String[]{"python", ".\\eye_check.py"}; // for windows
        excuteCommand1 = new String[]{"python", ".\\eye_check.py", "1"}; // for windows
        excuteCommand2 = new String[]{"python", ".\\eye_check.py", "2"}; // for windows
        excuteCommand3 = new String[]{"python", ".\\eye_check.py", "3"}; // for windows
        excuteCommand4 = new String[]{"python", ".\\eye_check.py", "4"}; // for windows
        excuteCommand5 = new String[]{"python", ".\\eye_check.py", "5"}; // for windows
        //excuteCommand = new String[]{"python3", "./eye_check.py"}; // for linux
    }
